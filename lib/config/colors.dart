...
// 19. background5: #E0E0E0 (Very Light Grey)
  ...
  LegendPalette get lightTheme {
    return LegendPalette(
      ...
      secondary: second,
      tertiary: a,
      foreground1: const Color(0xFF394B41),
      ...
      background1: const Color(0xFFfafefc),
      background2: const Color(0xFFf4fdf8),
      background3: const Color(0xFFeffcf5),
      background4: const Color(0xFFD9EDDF),
      background5: const Color(0xFF679C81),
